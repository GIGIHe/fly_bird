var Birds = function()
{
    ...
    var prepare = function()
    {
        ...
        bgTop.addColorStop(0, '#468e46');
        bgTop.addColorStop(1, '#bad85e');

        bgBot = engine.createLinearGradient(0, height / 2, 0, height);
        bgBot.addColorStop(0, '#f8f2e2');
        bgBot.addColorStop(1, '#f3c174');
    };
    ...
    var drawBird = function(bird)
    {
        ...
        var size = (width + height) / 100 * pos.z * z.current;
